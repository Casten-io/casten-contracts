...
contract PileTest is Interest, DSTest {
    ...
    function testincreaseDebtNoFixedFee() public {
        uint loan = 1;
        uint amount = 66 ether;
        // 12 % per year compound in seconds
        _setUpLoan(loan, 1000000003593629043335673583);
    ...
    function testincreaseDebtWithFixedFee() public {
        uint loan = 1;
    ...
    function testFailincreaseDebtNoAccrue() public {
        uint loan = 1;
        uint amount = 66 ether;
        // 12 % per year compound in seconds
        _setUpLoan(loan, 1000000003593629043335673583);
    ...
    function testChangeRate() public {
        ...
        pile.increaseDebt(loan, principal);
    ...
    function testChangeRateNoDebt() public {
        ...
        // check if rate is 12%
        pile.increaseDebt(loan, 100 ether);
        hevm.warp(block.timestamp + 1 days);
        pile.drip(highRate);
