...
contract SimpleMkr is Interest, DSTest, Auth {
    ...
    function file(bytes32 what, address addr) public {
        // enable file(bytes32, address) calls to make it compatible with the CastenManager interface
    ...
    function lock(uint amt) public {
        // enable lock(uint) calls to make it compatible with the CastenManager interface
